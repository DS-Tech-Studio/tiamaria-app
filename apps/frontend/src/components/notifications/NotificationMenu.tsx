  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative flex h-7 w-7 items-center justify-center rounded-md border border-rojizo/60 text-caramelo transition-all hover:border-caramelo hover:bg-borgoña hover:text-white active:scale-90 sm:h-8 sm:w-8"
        aria-label={`Notificaciones${unreadCount > 0 ? `, ${unreadCount} sin leer` : ''}`}
        aria-expanded={isOpen}
      >
        <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-4 w-4 sm:h-[1.1rem] sm:w-[1.1rem]">
          <path strokeLinecap="round" strokeLinejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0 1 18 14.158V11a6.002 6.002 0 0 0-4-5.659V5a2 2 0 1 0-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 1 1-6 0v-1m6 0H9" />
        </svg>
        {unreadCount > 0 && (
          <span className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-caramelo px-1 text-[9px] font-bold text-white shadow-md sm:h-5 sm:min-w-5 sm:text-[10px]">
